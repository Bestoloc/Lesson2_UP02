...
public class LoginController implements Initializable {
    ...
    public void showMainWindow(User person) {
        ...
        int roleName = Math.toIntExact(Manager.currentUser.getRoleId());
        switch (roleName){
            case 1:
                fxmlLoader = new FXMLLoader(TradeApp.class.getResource("client-view.fxml"));
                break;
            case 2:
                fxmlLoader = new FXMLLoader(TradeApp.class.getResource("admin-view.fxml"));
                break;
            case 3:
                fxmlLoader = new FXMLLoader(TradeApp.class.getResource("meneger-view.fxml"));
                break;
        }
        ...
        switch (roleName){
            case 1:
                newWindow.setTitle("Вы вошли как клиент");
                break;
            case 2:
                newWindow.setTitle("Вы вошли как администратор");
                break;
            case 3:
                newWindow.setTitle("Вы вошли как менеджер");
                break;
        }
